...
export async function loadEquippedPlayerCard(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to load your player card.');
    }

    const url = getPlatformUrl(platform, 'dbdPlayerCardGet');
