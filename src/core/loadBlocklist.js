...
export async function loadBlocklist(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to load your blocklist.');
    }

    const url = getPlatformUrl(platform, 'blockedPlayers');
