...
export async function getDPP(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to retrieve your disconnection penalty points.');
    }

    const url = getPlatformUrl(platform, 'banDecayAndGetDisconnectionPenaltyPoints');
