...
export async function getOnboardingProgress(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to retrieve your onboarding progress.');
    }

    const url = getPlatformUrl(platform, 'onboarding');
