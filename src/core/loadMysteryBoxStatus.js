...
export async function loadMysteryBoxStatus(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to load your mystery box status.');
    }

    const url = getPlatformUrl(platform, 'mysteryBoxStatus');
