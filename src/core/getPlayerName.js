...
export async function getPlayerName(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to retrieve your player name.');
    }

    const url = getPlatformUrl(platform, 'playername');
