...
export async function fetchContentVersion(platform) {
    if (!platform) {
        throw new Error('Platform is required to fetch content version.');
    }
    ...
    setRuntimeHeader('contentVersion', contentVersionPayload);
    console.log(`Fetched content version (${platform}):`, contentVersionPayload);

    return contentVersionPayload;
}