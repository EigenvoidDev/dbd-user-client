...
export async function claimRankRewards(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to claim your season refresh rewards.');
    }

    const url = getPlatformUrl(platform, 'claimRankRewards');
