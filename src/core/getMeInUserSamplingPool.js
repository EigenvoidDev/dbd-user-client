...
export async function getMeInUserSamplingPool(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to retrieve your HVS flag.');
    }

    const url = getPlatformUrl(platform, 'usersamplingMeInPool');
