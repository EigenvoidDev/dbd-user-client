...
export async function logout(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to log out.');
    }

    const url = getPlatformUrl(platform, 'logout');
