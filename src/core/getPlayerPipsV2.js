...
export async function getPlayerPipsV2(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to reset your rank and retrieve your player pips.');
    }

    const url = getPlatformUrl(platform, 'resetGetPipsV2');
