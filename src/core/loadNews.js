...
export async function loadNews(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to load your news.');
    }

    const url = getPlatformUrl(platform, 'news');
