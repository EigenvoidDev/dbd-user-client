...
export async function loadMessages(platform, bhvrSessionCookie, apiKey) {
    ...
    if (!bhvrSessionCookie || !apiKey) {
        throw new Error('Missing Cookie or api-key required to load your messages.');
    }

    const url = getPlatformUrl(platform, 'messages');
